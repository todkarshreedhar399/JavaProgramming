...
public class UserRegistration_UC13 {
    public static void main(String[] args) throws InvalidException {

        IUserRegistration_UC13 validatePassword = (String password) -> {
        ...
        IUserRegistration_UC13 validatePhoneNumber = (String phoneNumber) -> {
        ...
        IUserRegistration_UC13 validateUserEmail = (String email) -> {
        ...
        IUserRegistration_UC13 validateLastName = (String lastName) -> {
        ...
        IUserRegistration_UC13 validateFirstName = (String firstName)->{
            String regex = "^[A-Z][a-z]{2,}";
